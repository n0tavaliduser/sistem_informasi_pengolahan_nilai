<div class="modal fade" id="modal-create-{{ $siswa->id }}" tabindex="-1" aria-labelledby="modal-createLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('nilai-mata-pelajaran.store') }}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3 text-start">
                        ...
                        <input type="number" min="0" max="100" name="nilai" id="nilai" value="{{ Request::get('nilai') }}" class="form-control {{ !$errors->has('nilai')?:'is-invalid' }}" placeholder="Nilai">
                        @error('nilai')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
