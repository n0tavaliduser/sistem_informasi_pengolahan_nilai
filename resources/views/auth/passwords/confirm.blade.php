                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex flex-column h-100">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Sistem Informasi Pengolahan Nilai. Developed <i class="mdi mdi-heart text-danger"></i> by Dian</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
