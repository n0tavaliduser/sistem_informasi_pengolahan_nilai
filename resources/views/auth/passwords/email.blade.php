                            ...
                            <div class="row justify-content-center g-0">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index" class="d-block">
                                                    <img src="{{ URL::asset('build/images/logo-cds-sm.jpg') }}"
                                                        alt="CDS Asia Logo" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Reset password to continue to CDS Asia Electronics.</p>
                                        ...
                                        <div class="p-2">
                                            @if (session('status'))
                                                <div class="alert alert-success text-center mb-4" role="alert">
                                                    We have emailed you a new password. Please check your email.
                                                </div>
                                            @endif
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p>
                                ...
                                </script> Sistem Informasi Pengolahan Nilai. Developed <i
