                    ...
                    <div class="card overflow-hidden">
                        <div class="row g-0">
                            <div class="col-lg-6">
                                ...
                                style="
                                    background-image: url({{ URL::asset('assets/img/bg2.jpg') }});
                                    background-position: center;
                                    background-size: cover;
                                    background-repeat: no-repeat;
                                "
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div>
                                        ...
                                        <p class="text-muted">Sign in to continue to Edu System.</p>
                                    </div>
                                        ...
                                        <form action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" class="form-control pe-5 password-input @error('password') is-invalid @enderror" name="password" placeholder="Enter password" id="password-input" value="abcd1234">
                                                    @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        </script> Sistem Informasi Pengolahan Nilai. Developed <i class="mdi mdi-heart text-danger"></i> by Dian</p>
                    </div>
                </div>
            </div>
        </div>
